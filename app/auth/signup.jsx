...
import { Image, Keyboard, Text, View, StyleSheet, TouchableWithoutFeedback, ImageBackground, TouchableOpacity, TextInput, Pressable, KeyboardAvoidingView, Dimensions, Platform, ToastAndroid, ActivityIndicator } from "react-native";
    ...
    return (
        ...
        >
            ...
            <View style={styles.dropdownWrapper}>
                ...
                inputStyles={{fontSize: 15, color: colors.BG_color, fontFamily: 'PSemi-Bold'}}
                search={false}
                dropdownTextStyles={{fontSize: 15, color: "#000000", fontFamily: 'PSemi-Bold'}}
                dropdownStyles={{
                    borderWidth: 2,
